...
int main () {
    ...
    apparently that actually turns the number stored at the address const
    
    if you want an actually a const address , you write   int * const var     ;)
    ...
    *crosshair = 1; // ERROR - can't change the number stored at the address
    ...
    *box = 1; // the number stored at the address can be changed
    box = 0; // ERROR - can't change the addess cannot be changes tho
